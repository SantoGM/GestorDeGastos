...
public class BarViewExtended extends View {
    private int[] colors;
    ...
    public BarViewExtended(Context context) {
        this(context, null);
    }

    public BarViewExtended(Context context, AttributeSet attrs) {
        super(context, attrs);
        bgPaint = new Paint();
    ...
    private void setColor(int colorCode){
        fgPaint = new Paint(bgPaint);
        fgPaint.setColor(colors[colorCode]);
    }
