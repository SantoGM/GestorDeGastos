...
//            throw new RuntimeException(context.toString()
  //                  + " must implement OnFragmentInteractionListener");
    ...
    class LinealReportAdapter implements CompoundButton.OnCheckedChangeListener {
        ...
        private LineView lineViewFloat;
        private List<PaymenyPojo> paymenyPojos;
        ...
        public void setPaymentPojo(List<PaymenyPojo> payments){
            this.paymenyPojos=payments;
        }
        LinealReportAdapter(List<PaymenyPojo> paymenyPojos,LineView lineViewFloat, LinearLayout containerColors ){
            setPaymentPojo(paymenyPojos);
