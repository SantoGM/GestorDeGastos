...
public class ReportCakeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final List<PaymenyPojo> payments = ExpenseFacade.getInstance().getExpensesBetween(since, until, getContext());
        ...
        button_filter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    List<PaymenyPojo> paymentsLocal =ExpenseFacade.getInstance().getExpensesBetweenAndCats(categories,since, until,getContext());
...
//            throw new RuntimeException(context.toString()
    ...
    class ResumeReportAdapter extends BaseAdapter implements CompoundButton.OnCheckedChangeListener {
        ...
        private ArrayList<PaymenyPojo> paymenyPojos;
        ...
        private void fillDataHolder(){
            ...
            while (it.hasNext()){
                ...
                try{
                    ...
                    this.data.get(paymenyPojo.getCategory().getName()).values.add(paymenyPojo.getAmount());
                    this.data.get(paymenyPojo.getCategory().getName()).fechas.add(paymenyPojo.getDate().toString());
                }catch (Exception e){
                    Log.e("LinealReportAdapterACA",paymenyPojo.getDate().toString());
                    ...
                    this.data.put(paymenyPojo.getCategory().getName(),dataLine);
                }
        ...
        ResumeReportAdapter(List<PaymenyPojo> paymenyPojos, LinearLayout containerColors, Context context, int layout){


            this.paymenyPojos =  new ArrayList<>(paymenyPojos);
        ...
        public View getView(int position, View convertView, ViewGroup viewGroup) {
            ...
            PaymenyPojo currentPayment  = paymenyPojos.get(position);
        ...
        @Override
        public int getCount() {
            return this.paymenyPojos.size();
        }

        @Override
        public Object getItem(int position) {
            return this.paymenyPojos.get(position);
        }
